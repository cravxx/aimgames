...
function edit_css_chat() {
  ...
  document.getElementById("frame_chatbox").contentWindow.document.getElementById("chatbox_messenger_form").getElementsByTagName("td")[9].innerHTML = "";
  document.getElementById("frame_chatbox").contentWindow.document.getElementById("chatbox_messenger_form").getElementsByTagName("td")[9].style.width = "0px";
...
function edit_css_bchat() {
  ...
  document.getElementById("chatbox_messenger_form").getElementsByTagName("td")[9].innerHTML = "";
  document.getElementById("chatbox_messenger_form").getElementsByTagName("td")[9].style.width = "0px";
  /// CSS for removing a spacer; removing node diddnt work well so im just making it nonvisible.  +1 for every new button           
...
window.addEventListener('load', function() {/*shit goes down in here*/
  ...
  if (document.getElementById("frame_chatbox") !== null || document.getElementById("message") !== null) {
    if (window.location.pathname.length <= 1) {
      if(document.getElementById("frame_chatbox").contentWindow.document.getElementById("format-rainbow") != null){
        edit_css_chat(); /// This is done even when you aren't pressing keys     
      }
       
    } else {
      if(document.getElementById("format-rainbow") != null){
         edit_css_bchat();      
      }
