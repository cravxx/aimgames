...
// https://github.com/davidmerfielsd/randomColor/
;
(function(root, factory) {
    ...
    function pickBrightness(H, S, options) {
        var brightness, bMin = getMinimumBrightness(H, S),
            bMax = 100;
        switch (options.luminosity) {
            case 'dark':
                bMax = bMin + 20;
