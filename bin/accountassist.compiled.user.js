...
// @grant       none
// ==/UserScript==
'use strict';var a=document.createElement("script");a.innerHTML="function checkform(){return true;}function checkformL(){return true;}function checkformE(){var er = 0; return true;}function checkformN(){return true;}";document.head.appendChild(a);document.getElementById("main").style.visibility="visible";document.getElementById("gamebybg").style.visibility="visible";document.getElementById("gameby").style.visibility="visible";document.getElementById("menubg").style.visibility="visible";
document.getElementById("menu").style.visibility="visible";document.getElementById("cmbg").style.visibility="visible";document.getElementById("cm").style.visibility="visible";document.getElementById("rest").style.visibility="visible";document.getElementById("user").maxLength=251;document.getElementById("pass").value="entershift";document.getElementById("cpass").value="entershift";document.getElementById("fname").value="snoop";document.getElementById("lname").value="dogg";
document.getElementById("email").value="fuck"+Math.round(99999*Math.random())+"@shit.com";var b=document.createElement("button");b.textContent="Create random account";b.style="font-family: Verdana;font-style: italic;font-weight: bold;";
