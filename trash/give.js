...
give.me.nouns = ['stitch', 'square', 'leather', 'bucket', 'church',
    ...
    'office', 'army', 'shelf', 'cows', 'club', 'fly', 'rings',
    'walk', 'pollution', 'jewel', 'jail', 'powder', 'building',
    'rod', 'fish', 'memory', 'debt', 'desire', 'driving',
    'winter', 'wave', 'elbow', 'crown', 'twig', 'swing', 'love',
    'glass', 'morning', 'lumber', 'coil', 'flight', 'step',
    'expert', 'zipper', 'lamp', 'fang', 'bells', 'dinosaurs',
    'ray', 'shop', 'friction', 'pipe', 'mist', 'sock', 'vest',
    'crack', 'cannon', 'back', 'whip', 'north', 'basket',
    'history', 'robin', 'pigs', 'wheel', 'crib', 'mask', 'paper',
    'action', 'cellar', 'turn', 'wall', 'bushes', 'color', 'fuel',
    'plough', 'advertisement', 'party', 'needle', 'toad',
    'reading', 'committee', 'slip', 'volleyball', 'floor', 'wren',
    ...
    'day', 'rain', 'credit', 'partner', 'ink', 'reward', 'snake',
    'women', 'note', 'wing', 'sugar', 'shade', 'wrist', 'smoke',
    'position', 'monkey', 'direction', 'achiever', 'battle',
    'yak', 'stranger', 'calendar', 'value', 'test', 'trains',
    'minister', 'zebra', 'wish', 'distribution', 'blood',
    ...
    'hot', 'invention', 'deer', 'hole', 'frame', 'top', 'key',
    ...
    'rate', 'men', 'condition', 'truck', 'tongue', 'industry',
...
give.me.adjectives = ['abrupt', 'acidic', 'adorable', 'adventurous',
    ...
    'amused', 'annoyed', 'antsy', 'anxious', 'appalling',
    'appetizing', 'apprehensive', 'arrogant', 'ashamed',
    'astonishing', 'attractive', 'average', 'batty', 'beefy',
    'bewildered', 'biting', 'bitter', 'bland', 'blushing',
    'bored', 'brave', 'bright', 'broad', 'bulky', 'burly',
    'charming', 'cheeky', 'cheerful', 'chubby', 'clean', 'clear',
    'cloudy', 'clueless', 'clumsy', 'colorful', 'colossal',
    'combative', 'comfortable', 'condemned', 'condescending',
    'confused', 'contemplative', 'convincing', 'convoluted',
    'cooperative', 'corny', 'costly', 'courageous', 'crabby',
    'creepy', 'crooked', 'cruel', 'cumbersome', 'curved',
    'cynical', 'dangerous', 'dashing', 'decayed', 'deceitful',
    'deep', 'defeated', 'defiant', 'delicious', 'delightful',
    'depraved', 'depressed', 'despicable', 'determined',
    'dilapidated', 'diminutive', 'disgusted', 'distinct',
    'distraught', 'distressed', 'disturbed', 'dizzy', 'drab',
    'drained', 'dull', 'eager', 'ecstatic', 'elated', 'elegant',
    ...
    'floppy', 'fluttering', 'foolish', 'frantic', 'fresh',
    'friendly', 'frightened', 'frothy', 'frustrating', 'funny',
    'fuzzy', 'gaudy', 'gentle', 'ghastly', 'giddy', 'gigantic',
    'glamorous', 'gleaming', 'glorious', 'gorgeous', 'graceful',
    'greasy', 'grieving', 'gritty', 'grotesque', 'grubby',
    'grumpy', 'handsome', 'happy', 'harebrained', 'healthy',
    ...
    'kind', 'lackadaisical', 'large', 'lazy', 'lethal', 'little',
    ...
    'petite', 'petty', 'plain', 'pleasant', 'poised', 'pompous',
    'precious', 'prickly', 'proud', 'pungent', 'puny', 'quaint',
    ...
    'shiny', 'short', 'silky', 'silly', 'skinny', 'slimy',
    'slippery', 'small', 'smarmy', 'smiling', 'smoggy', 'smooth',
    'smug', 'soggy', 'solid', 'sore', 'sour', 'sparkling',
    'spicy', 'splendid', 'spotless', 'square', 'stale', 'steady',
    'steep', 'sticky', 'stormy', 'stout', 'straight', 'strange',
    'strong', 'stunning', 'substantial', 'successful',
    ...
    'vivid', 'wacky', 'weary', 'whimsical', 'whopping', 'wicked',
    'witty', 'wobbly', 'wonderful', 'worried', 'yummy', 'zany',
    'zealous', 'zippy', 'sudden', 'infamous', 'endurable',
    'curious', 'three', 'meaty', 'innate', 'habitual', 'complex',
    'third', 'cut', 'idiotic', 'abrasive', 'addicted',
    'disastrous', 'pathetic', 'taboo', 'known', 'likeable',
    'thundering', 'careful', 'legal', 'ahead', 'observant',
    'intelligent', 'lush', 'futuristic', 'hard', 'abounding',
    'neat', 'wet', 'easy', 'flowery', 'earsplitting', 'mean',
    'left', 'half', 'scared', 'safe', 'romantic', 'swift',
    'assorted', 'threatening', 'jazzy', 'sincere', 'nifty',
    'stiff', 'low', 'unused', 'sneaky', 'gaping', 'able', 'gabby',
    'berserk', 'blue', 'callous', 'unusual', 'eatable', 'purring',
    'nebulous', 'stupendous', 'guiltless', 'imminent',
    'unsuitable', 'ugly', 'heavenly', 'chilly', 'forgetful',
    'foamy', 'rampant', 'tiresome', 'neighborly', 'melodic',
    'wide', 'ill-informed', 'spiffy', 'obsolete', 'tranquil',
    'exclusive', 'incandescent', 'brown', 'woebegone',
    'beneficial', 'vague', 'orange', 'woozy', 'detailed',
    'ad hoc', 'unbiased', 'light', 'possessive', 'same',
    'far-flung', 'barbarous', 'historical', 'expensive',
    'majestic', 'cautious', 'fumbling', 'beautiful', 'serious',
    'versed', 'exultant', 'awful', 'whispering', 'tedious',
    'unadvised', 'new', 'curvy', 'protective', 'shocking',
    'pushy', 'handsomely', 'abortive', 'unwritten', 'red',
    'knotty', 'sordid', 'tough', 'overwrought', 'craven',
    'numberless', 'fascinated', 'clever', 'dusty', 'divergent',
    'false', 'direful', 'standing', 'faulty', 'faint', 'wiggly',
    'scandalous', 'noiseless', 'terrific', 'opposite', 'two',
    'debonair', 'imported', 'nosy', 'obscene', 'vulgar', 'tacit',
    'painful', 'previous', 'kindhearted', 'macabre', 'delirious',
    ...
    'cooing', 'hushed', 'chunky', 'oafish', 'wandering',
    'black-and-white', 'messy', 'right', 'economic', 'gusty',
    'elite', 'five', 'supreme', 'giant', 'innocent', 'deafening',
    'racial', 'bad', 'old-fashioned', 'vacuous', 'selective',
    'grey', 'faithful', 'volatile', 'greedy', 'fine', 'puzzling',
    'picayune', 'familiar', 'tame', 'thirsty', 'early',
    'unaccountable', 'adhesive', 'near', 'full', 'accessible',
    'abusive', 'learned', 'material', 'humorous', 'brawny',
    'well-made', 'blue-eyed', 'illustrious', 'hulking',
    'rhetorical', 'spiky', 'nimble', 'furtive', 'deadpan',
    'internal', 'wiry', 'sulky', 'quickest', 'last', 'caring',
    'waiting', 'torpid', 'imperfect', 'kindly', 'quixotic',
    'cowardly', 'maddening', 'uttermost', 'ossified', 'truculent',
    'unbecoming', 'modern', 'fixed', 'makeshift', 'obtainable',
    'equable', 'premium', 'rainy', 'dynamic', 'slim', 'freezing',
    'plastic', 'wry', 'stereotyped', 'skillful', 'absent',
    'thinkable', 'daily', 'steadfast', 'curly', 'special',
    'measly', 'silent', 'nostalgic', 'disillusioned', 'ritzy',
    'disagreeable', 'stupid', 'towering', 'defective', 'simple',
    'snobbish', 'aback', 'sable', 'real', 'lame', 'functional',
    'first', 'past', 'hanging', 'flimsy', 'loutish', 'used',
    'invincible', 'aromatic', 'periodic', 'probable',
    'glistening', 'guttural', 'mighty', 'bumpy', 'nine',
    'squeamish', 'grouchy', 'warm', 'tacky', 'quirky',
    'nondescript', 'delicate', 'various', 'dreary', 'hysterical',
    'hypnotic', 'overrated', 'brainy', 'deserted', 'jumbled',
    'alike', 'teeny-tiny', 'incompetent', 'piquant', 'obsequious',
    'lamentable', 'tan', 'uppity', 'milky', 'aspiring', 'lavish',
    'public', 'afraid', 'befitting', 'lying', 'sassy',
    'efficient', 'well-to-do', 'mixed', 'mature', 'laughable',
    'fanatical', 'doubtful', 'bizarre', 'clammy', 'organic',
    'white', 'ethereal', 'null', 'aboriginal', 'slow',
    'responsible', 'windy', 'capricious', 'overjoyed', 'gullible',
    'classy', 'hard-to-find', 'fluffy', 'mountainous', 'holistic',
    'spectacular', 'worthless', 'willing', 'valuable', 'chief',
    'cloistered', 'fretful', 'utter', 'yielding', 'insidious',
    'phobic', 'bent', 'acid', 'muddled', 'dapper', 'handy',
    'boundless', 'certain', 'cute', 'minor', 'weak', 'horrible',
    'onerous', 'one', 'highfalutin', 'ordinary', 'hot', 'nonstop',
    'rich', 'righteous', 'different', 'talented', 'gruesome',
    'oval', 'absorbing', 'bloody', 'acoustic', 'high-pitched',
    'gray', 'waggish', 'womanly', 'boiling', 'difficult',
    'screeching', 'political', 'alcoholic', 'naive', 'ill',
    'striped', 'honorable', 'eminent', 'illegal', 'noisy',
    'apathetic', 'disgusting', 'squalid', 'drunk', 'zonked',
    'heartbreaking', 'violent', 'longing', 'great', 'changeable',
    'undesirable', 'rigid', 'alive', 'enchanted', 'tawdry',
    'coordinated', 'rapid', 'best', 'mute', 'boring',
    'inquisitive', 'cheap', 'parsimonious', 'spooky', 'shivering',
    'ten', 'ceaseless', 'better', 'glib', 'tired', 'possible',
    'secret', 'bustling', 'deranged', 'succinct', 'bashful',
    ...
    'pricey', 'ambiguous', 'rude', 'loving', 'outgoing',
    'harmonious', 'tasteful', 'synonymous', 'malicious', 'female',
    'unknown', 'fair', 'dysfunctional', 'descriptive', 'amazing',
    'second-hand', 'tiny', 'next', 'dirty', 'impolite', 'royal',
    'bawdy', 'abaft', 'limping', 'awake', 'lewd', 'efficacious',
    'mindless', 'sweltering', 'fast', 'breezy', 'temporary',
    'rural', 'gifted', 'goofy', 'future', 'awesome',
    'therapeutic', 'truthful', 'decisive', 'tremendous',
    'unkempt', 'wealthy', 'domineering', 'faded', 'childlike',
    'flagrant', 'well-groomed', 'plucky', 'resolute', 'dark',
    'utopian', 'pale', 'feeble', 'uninterested', 'concerned',
    ...
    'uncovered', 'inexpensive', 'festive', 'abhorrent',
    'unequaled', 'living', 'profuse', 'agreeable', 'demonic',
    'military', 'upbeat', 'entertaining', 'scientific', 'broken',
    'tangy', 'long-term', 'diligent', 'rebel', 'harsh',
    'rightful', 'ultra', 'gainful', 'sophisticated', 'frail',
    'discreet', 'toothsome', 'ubiquitous', 'finicky', 'long',
    'guarded', 'stimulating', 'amuck', 'abundant', 'violet',
    'sleepy', 'aquatic', 'ruthless', 'frightening', 'humdrum',
    'painstaking', 'statuesque', 'hellish', 'savory', 'flippant',
    'hesitant', 'flawless', 'angry', 'unhealthy', 'evanescent',
    'grandiose', 'elfin', 'garrulous', 'deeply', 'hurried',
    'well-off', 'shy', 'rare', 'ambitious', 'automatic', 'exotic',
    'scarce', 'placid', 'agonizing', 'reminiscent', 'omniscient',
    'merciful', 'marked', 'gamy', 'true', 'lacking', 'medical',
    'decorous', 'squealing', 'chivalrous', 'fortunate',
    'excellent', 'staking', 'cultured', 'psychedelic', 'trashy',
    'verdant', 'extra-small', 'lyrical', 'famous', 'knowing',
    'knowledgeable', 'amusing', 'irritating', 'dazzling', 'lean',
    'imaginary', 'subsequent', 'parallel', 'permissible',
    'billowy', 'far', 'workable', 'wise', 'tightfisted',
    'available', 'vagabond', 'oceanic', 'zesty', 'dead',
    'psychotic', 'pointless', 'calculating', 'alluring',
    'satisfying', 'married', 'youthful', 'magical', 'male',
    'accurate', 'moldy', 'optimal', 'wretched', 'hapless',
    'magenta', 'young', 'tall', 'inconclusive', 'actually',
    'untidy', 'present', 'aberrant', 'numerous', 'halting',
    ...
    'spotty', 'instinctive', 'adjoining', 'stingy', 'shut',
    'incredible', 'electric', 'ablaze', 'unique', 'cool',
    'understood', 'roasted', 'juvenile', 'purple', 'pumped',
    'ignorant', 'foregoing', 'sad', 'nappy', 'elderly', 'hissing',
    'lopsided', 'lumpy', 'exciting', 'murky', 'rustic',
    ...
    'draconian', 'dry', 'abject', 'unwieldy', 'thin', 'perpetual',
...
give.me.verbs = ['warm', 'step', 'hand', 'multiply', 'decay', 'bore',
    ...
    'moan', 'drip', 'afford', 'balance', 'start', 'chase', 'join',
    'risk', 'sniff', 'report', 'glue', 'bleach', 'call', 'paint',
    ...
    'tire', 'introduce', 'enjoy', 'tour', 'fire', 'murder',
    'blind', 'yawn', 'destroy', 'excuse', 'bake', 'film', 'mug',
    'explode', 'marry', 'fry', 'tempt', 'mix', 'tumble', 'invite',
    'ruin', 'trade', 'charge', 'remember', 'behave', 'scorch',
    ...
    'seal', 'extend', 'injure', 'attack', 'crash', 'separate',
    ...
    'rinse', 'scrape', 'kick', 'load', 'beam', 'order', 'sack',
    'examine', 'grin', 'boast', 'squash', 'squeal', 'connect',
    'test', 'remain', 'joke', 'tug', 'cheer', 'fade', 'spoil',
    'stare', 'pop', 'attract', 'thank', 'suit', 'found',
    'continue', 'judge', 'hug', 'warn', 'expect', 'argue', 'fill',
    'level', 'last', 'shave', 'employ', 'branch', 'regret',
    'shock', 'roll', 'treat', 'prepare', 'remove', 'increase',
    'tickle', 'chop', 'hunt', 'wreck', 'curl', 'melt', 'tease',
    'support', 'whip', 'pull', 'place', 'scratch', 'x-ray',
    'apologise', 'fear', 'use', 'pack', 'protect', 'reduce',
    'repeat', 'sparkle', 'unite', 'decorate', 'obtain',
    'disagree', 'prick', 'reject', 'reflect', 'owe', 'guard',
    'subtract', 'hammer', 'turn', 'prefer', 'mess up', 'serve',
    'choke', 'grip', 'promise', 'rely', 'love', 'pine', 'settle',
    'fool', 'deserve', 'spare', 'back', 'instruct', 'suspect',
    'snatch', 'time', 'reach', 'need', 'heap', 'memorise',
    'prevent', 'hope', 'dance', 'plant', 'skip', 'perform',
    'care', 'guess', 'cough', 'boil', 'live', 'blink', 'wink',
    'pinch', 'taste', 'consider', 'analyse', 'please', 'accept',
    'pedal', 'greet', 'surround', 'describe', 'harass', 'radiate',
    'gaze', 'sneeze', 'replace', 'print', 'delay', 'alert',
    ...
    'drown', 'claim', 'include', 'flower', 'lighten', 'bubble',
    'twist', 'announce', 'request', 'follow', 'sin', 'rescue',
    'program', 'receive', 'inform', 'kill', 'interest', 'notice',
    'zoom', 'trip', 'coach', 'rot', 'cheat', 'crack', 'permit',
    'drain', 'collect', 'whistle', 'park', 'empty', 'buzz',
