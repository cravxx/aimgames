...
sh compile.sh ../bin/accountassist.compiled.min.user.js "../bin/accountassist.compiled.min.user.js" 10 || exit 1
sh compile.sh ../bin/alive.compiled.min.user.js "../bin/alive.compiled.min.user.js" 10 || exit 1
sh compile.sh ../bin/chameleon.compiled.min.user.js "../bin/chameleon.compiled.min.user.js" 10 || exit 1
sh compile.sh ../bin/chameleon_random.compiled.min.user.js "../bin/chameleon_random.compiled.min.user.js" 10 || exit 1
sh compile.sh ../bin/chameleon_vampire.compiled.min.user.js "../bin/chameleon_vampire.compiled.min.user.js" 10 || exit 1
sh compile.sh ../bin/chatboxplusplus-v2.compiled.min.user.js "../bin/chatboxplusplus-v2.compiled.min.user.js" 10 || exit 1
sh compile.sh ../bin/chatboxplusplus.compiled.min.user.js "../bin/chatboxplusplus.compiled.min.user.js" 10 || exit 1
sh compile.sh ../bin/imagereuploader.compiled.min.user.js "../bin/imagereuploader.compiled.min.user.js" 10 || exit 1
sh compile.sh ../bin/ratebot.compiled.min.user.js "../bin/ratebot.compiled.min.user.js" 10 || exit 1
sh compile.sh ../bin/swearify.compiled.min.user.js "../bin/swearify.compiled.min.user.js" 10 || exit 1
sh compile.sh ../bin/swearify_image_utility.compiled.min.user.js "../bin/swearify_image_utility.compiled.min.user.js" 10 || exit 1
sh compile.sh ../bin/swearify_v2.compiled.min.user.js "../bin/swearify_v2.compiled.min.user.js" 10 || exit 1
